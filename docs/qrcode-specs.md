...
| Spec reference | Topic | Implementation |
|---|---|---|
| Table 7-11 | Data capacity per version / ECC level | [QRCodeConstants.capacityBaseValues](../src/SkiaSharp.QrCode/Internals/QRCodeConstants.cs) — practical capacities are documented in [Data Capacity Reference](data-capacity.md) |
