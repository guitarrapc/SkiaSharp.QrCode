...
| Section 7.7 | Inverse zigzag codeword extraction with on-the-fly unmasking, reusing the encoder's own function-module predicate and mask so both sides always agree | [RmQRMatrixDecoder.ExtractCodewords](../../../src/SkiaSharp.QrCode/Internals/RmQr/RmQRMatrixDecoder.cs) |
