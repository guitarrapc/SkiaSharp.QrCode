...
| - | Binarization (Otsu), finder candidates (row-strided scan, complementary pass over the skipped rows unless a candidate was confirmed on two or more rows) | [Binarizer](../../../src/SkiaSharp.QrCode/Internals/ImageDecoders/Binarizer.cs), [FinderPatternFinder.FindCandidates](../../../src/SkiaSharp.QrCode/Internals/ImageDecoders/FinderPatternFinder.cs), shared across symbologies |
