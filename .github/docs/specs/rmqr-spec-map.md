...
| Section 7.4.3-7.4.5 | Numeric / Alphanumeric / Byte segment bit streams | [RmQRBinaryEncoder](../../../src/SkiaSharp.QrCode/Internals/RmQr/RmQRBinaryEncoder.cs) (single segment, Latin-1 narrow / UTF-8 transcode without ECI; raw-local writer with SWAR / SSE numeric and alphanumeric kernels and an SSE2 Latin-1 narrow for Byte mode, parity-pinned by `RmQRBinaryEncoderParityTest` / `RmQRBinaryEncoderKernelParityTest`) |
