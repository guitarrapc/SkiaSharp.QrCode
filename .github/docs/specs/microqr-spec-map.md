...
| Section 7.4.3-7.4.5 | Numeric / Alphanumeric / Byte segment bit streams (128-bit register accumulator — the stream never exceeds 16 codeword bytes; byte-mode Latin-1 runs SIMD tiers: SSE2 8-char narrow on x64, and on ARM64 a NEON overlapped-load tier for 8-15 chars plus a 64-bit SWAR tier for 4-7 chars, both exploiting the ≤ 15-char payload ceiling; portable scalar fallback elsewhere) | [MicroQrBinaryEncoder](../../../src/SkiaSharp.QrCode/Internals/MicroQr/MicroQrBinaryEncoder.cs) |
